...
const MotivationalQuote = () => {
  ...
  const quotes = [
    ...
    { text: "Science is a beautiful gift to humanity; we should not distort it.", author: "APJ Abdul Kalam" },
    { text: "Poetry comes from the highest happiness or the deepest sorrow.", author: "APJ Abdul Kalam" },
    { text: "For great men, religion is a way of making friends; small people make religion a fighting tool.", author: "APJ Abdul Kalam" },
    { text: "When it rains, ordinary birds seek shelter, but the eagle avoids the rain by flying above the clouds.", author: "APJ Abdul Kalam" },
    { text: "As a child of God, I am greater than anything that can happen to me.", author: "APJ Abdul Kalam" },
    { text: "Ultimately, education in its real sense is the pursuit of truth.", author: "APJ Abdul Kalam" },
    { text: "If you fail, never give up because F.A.I.L. means 'First Attempt In Learning'.", author: "APJ Abdul Kalam" },
    { text: "All of us do not have equal talent. But, all of us have an equal opportunity to develop our talents.", author: "APJ Abdul Kalam" },
    ...
    { text: "Learning gives creativity, creativity leads to thinking, thinking provides knowledge, knowledge makes you great.", author: "APJ Abdul Kalam" },
    { text: "The best brains of the nation may be found on the last benches of the classroom.", author: "APJ Abdul Kalam" },
    { text: "End is not the end, in fact E.N.D. means 'Effort Never Dies'.", author: "APJ Abdul Kalam" },
    { text: "Let us sacrifice our today so that our children can have a better tomorrow.", author: "APJ Abdul Kalam" },
    { text: "I am not handsome but I can give my hand to someone who needs help... Because beauty is required in the heart, not in face.", author: "APJ Abdul Kalam" },
    { text: "Look at the sky. We are not alone. The whole universe is friendly to us and conspires only to give the best to those who dream and work.", author: "APJ Abdul Kalam" },
    { text: "Be more dedicated to making solid achievements than in running after swift but synthetic happiness.", author: "APJ Abdul Kalam" },
    { text: "Thinking is the capital, enterprise is the way, hard work is the solution.", author: "APJ Abdul Kalam" },
    { text: "We should not give up and we should not allow the problem to defeat us.", author: "APJ Abdul Kalam" },
    { text: "Failure will never overtake me if my determination to succeed is strong enough.", author: "APJ Abdul Kalam" },
    { text: "Active learning is the foundational requirement for building a strong, successful mind.", author: "APJ Abdul Kalam" },
    { text: "A dream is not that which you see while sleeping, it is something that does not let you sleep.", author: "APJ Abdul Kalam" },
    { text: "To become 'unique,' the challenge is to fight the hardest battle which anyone can imagine until you reach your destination.", author: "APJ Abdul Kalam" },
    { text: "Climbing to the top demands strength, whether it is to the top of Mount Everest or to the top of your career.", author: "APJ Abdul Kalam" },
    { text: "Those who cannot work with their hearts achieve but a hollow, half-hearted success that breeds bitterness all around.", author: "APJ Abdul Kalam" },
    { text: "Education is the most powerful weapon which you can use to change the world.", author: "APJ Abdul Kalam" },
    { text: "Without your involvement you can't succeed. With your involvement you can't fail.", author: "APJ Abdul Kalam" },
    { text: "One best book is equal to a hundred good friends, but one good friend is equal to a library.", author: "APJ Abdul Kalam" },
    { text: "My message, especially to young people is to have courage to think differently, courage to invent, to travel the unexplored path.", author: "APJ Abdul Kalam" },
    { text: "If four things are followed - having a great aim, acquiring knowledge, hard work, and perseverance - then anything can be achieved.", author: "APJ Abdul Kalam" },
